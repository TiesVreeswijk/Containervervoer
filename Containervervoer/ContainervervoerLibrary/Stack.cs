...
public class Stack
{
    ...
    private bool BlocksValuable()
    {
        ...
        var stackBefore = currentRowIndex > 0 ? ParentRow.ParentShip.Rows[currentRowIndex - 1].Stacks[currentStackIndex] : null;
        var stackTwoBefore = currentRowIndex > 1 ? ParentRow.ParentShip.Rows[currentRowIndex - 2].Stacks[currentStackIndex] : null;
        
        var stackAfter = currentRowIndex < ParentRow.ParentShip.Rows.Count - 1 ? ParentRow.ParentShip.Rows[currentRowIndex + 1].Stacks[currentStackIndex] : null;
        var stackTwoAfter = currentRowIndex < ParentRow.ParentShip.Rows.Count - 2 ? ParentRow.ParentShip.Rows[currentRowIndex + 2].Stacks[currentStackIndex] : null;
    ...
    private bool CanAcces()
    {
        ...
        if(currentRowIndex == 0 ||
           ...
           ParentRow.ParentShip.Rows[currentRowIndex - 1].Stacks[currentStackIndex].Containers.Count <= Containers.Count ||
           ParentRow.ParentShip.Rows[currentRowIndex + 1].Stacks[currentStackIndex].Containers.Count <= Containers.Count) return true;
